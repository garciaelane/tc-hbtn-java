public class Program {
    public static void main(String[] args) {
        ...
        resumo_pedido.produtos.Livro livro2 = new resumo_pedido.produtos.Livro("Um de nós está mentindo", 2018, "Brasil", 34.93, 384,
                "Karen Mcmanus", 1);
        resumo_pedido.produtos.Livro livro3 = new resumo_pedido.produtos.Livro("Mindset Milionário", 2021, "Brasil", 31.70, 272,
                "José Roberto Marques", 1);

        resumo_pedido.produtos.Dvd dvd1 = new resumo_pedido.produtos.Dvd("Anjos da Noite 5 - Guerras de Sangue", 2016, "Estados Unidos", 16.90,
                "Anna Foerster",
                "Ação", 91);
        resumo_pedido.produtos.Dvd dvd2 = new resumo_pedido.produtos.Dvd("Annabelle 2 - A Criação do Mal", 2017, "Brasil", 39.90,
